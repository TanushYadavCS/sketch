...
export const INTEGRATIONS: IntegrationDefinition[] = [
  ...
  },
  {
    ...
    authFields: [
      {
        ...
        helpText: "Application (client) ID from Microsoft Entra",
      },
      {
        key: "client_secret",
        label: "Client Secret",
        type: "password",
        placeholder: "...",
        helpText: "Client secret value from Microsoft Entra",
      },
    ],
    scopeLabel: "mailbox",
    scopeType: "none",
    ...
    connectSteps: [
      ...
      "Paste the Client ID and Client Secret, then connect with Microsoft",
    ],
    perUserAuth: true,
    requiresOAuthClientSetup: true,
  },
  {
    ...
    connectSteps: [
      "Register an app in Microsoft Entra",
      "Add the redirect URI shown by your deployment",
      "Grant delegated calendar, online meeting, transcript, and recording metadata permissions",
