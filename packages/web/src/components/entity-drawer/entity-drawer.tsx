...
import { SectionCard, SectionLabel, formatRelative } from "./drawer-kit";
...
function DrawerTabs({ entityId, sourceType, relations, relationsLoading, isAdmin }: DrawerTabsProps) {
