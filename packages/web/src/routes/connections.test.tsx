...
describe("ConnectionsPage helpers", () => {
  ...
  it("treats org-shared apps as ordinary connections when access settings are disabled", () => {
    const connections = [
      {
        id: "secrets:owner-1:github:github",
        providerId: "provider-1",
    ...
    expect(getPersonallyConnectedAppIds(connections, false)).toEqual(new Set(["github", "slack"]));
  });
});
