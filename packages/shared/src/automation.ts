...
export const workflowTriggerConfigSchema = z
  .object({
    ...
    webhookAuthentication: z.literal("bearer_or_hmac_sha256").optional(),
    webhookSignatureHeader: z.literal("X-Sketch-Webhook-Signature").optional(),
    webhookIdempotencyHeader: z.literal("Idempotency-Key").optional(),
    webhookPayloadLimitBytes: z.literal(1_000_000).optional(),
