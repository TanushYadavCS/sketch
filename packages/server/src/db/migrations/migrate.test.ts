 ...
 *
 * Uses a fresh in-memory SQLite database and runs all 040 migrations through the
 ...
 * with migrations 001-018 already applied can be upgraded with only 019-040.
 */
...
describe("runMigrations — incremental upgrade", () => {
  ...
  it("applies only 019-040 when 001-018 are already present", async () => {
