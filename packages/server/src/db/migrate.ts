...
import * as m055 from "./migrations/055-entity-review-queue";
import * as m056 from "./migrations/056-entity-mentions-unique";
    ...
    provider: {
      async getMigrations() {
        return {
          ...
          "055-entity-review-queue": m055,
          "056-entity-mentions-unique": m056,
        };
      },
    },
  });
