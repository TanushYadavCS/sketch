...
import * as m042 from "./migrations/042-entity-mentions-composite-index";
import * as m043 from "./migrations/043-users-timezone";
    ...
    provider: {
      async getMigrations() {
        return {
          ...
          "042-entity-mentions-composite-index": m042,
          "043-users-timezone": m043,
        };
      },
    },
  });
