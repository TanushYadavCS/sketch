 ...
 * GetTeamDirectory (discover team members), SendMessageToUser (send a DM and
 * create a one-way inbox record for the recipient), and inbox workflow helpers
 * for updating and resolving explicit inbox tasks.
 *
