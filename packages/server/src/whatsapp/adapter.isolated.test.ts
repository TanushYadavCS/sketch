  ...
  describe("group handler", () => {
    ...
    it("does not wire group tool progress when explicitly enabled", async () => {
      ...
      vi.mocked(deps.repos.whatsappGroups.getByJid).mockResolvedValue({
        ...
        chunk_min_messages: null,
        chunk_target_messages: null,
        chunk_max_messages: null,
        chunk_max_tokens: null,
        chunk_tick_minutes: null,
        chunk_idle_close_hours: null,
        chunk_provisional_refresh_messages: null,
        chunk_model: null,
        chunk_reasoning_effort: null,
        chunk_burst_threshold_messages: null,
        chunk_topic_registry_cap: null,
        chunk_group_worker_pool: null,
