...
export class AgentRunService {
  private readonly repo: ReturnType<typeof createAgentOutputRepository>;
  private readonly deps: AgentRunServiceDeps;
  private readonly runQueue: AgentOutputRunQueue;
