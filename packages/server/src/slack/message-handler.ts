 ...
 * runAgent(). onFinalMessage handles the first-message-replaces-thinking /
 * subsequent-messages-are-new pattern. onToolProgress posts and edits a
 * single progress message with accumulated tool call lines.
 *
