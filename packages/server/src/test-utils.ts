...
export function createTestConfig(overrides: Partial<Config> = {}): Config {
  return {
    ...
    WHATSAPP_BACKFILL_GRAPH_PAGE_TOKENS: 20_000,
    ...
    GRAPH_CURATION_TOOLS_ENABLED: false,
